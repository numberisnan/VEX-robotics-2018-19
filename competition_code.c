...
#pragma config(Motor,  port6,           motup,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           motspin,       tmotorServoStandard, openLoop)
...
inline void setmotor(int fl, int fr, int bl, int br){
	motor[mot2] = fl;
	motor[mot3] = fr;
	motor[mot4] = bl;
	motor[mot5] = br;
...
inline void setarmup(int val){
	motor[motup] = val;
}

inline void setarmspin(int val){
	motor[motspin] = val;
}
